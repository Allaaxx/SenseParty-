    ...
    <div class="left-side-bar">
        <div class="brand-logo" style="overflow: hidden">
            ...
            <div class="close-sidebar" data-toggle="left-sidebar-close">
                <i class="ion-close-round mx-3"></i>
            </div>
        </div>
                    ...
                    @if (Route::is('admin.*'))
                        ...
                        <li>
                            <a href="{{ route('admin.manage-categories.cats-subcats-list') }}"
                                ...
                                <span class="micon dw dw-align-left3"></span><span class="mtext">Gerenciar
                                    categorias</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.settings') }}"
                                ...
                                <span class="mtext">Configurações
                                </span>
                            </a>
                        </li>
                    @else
                        ...
                        <li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle {{ Route::is('seller.product.*') ? 'active' : ''}}">
								<span class="micon bi bi-bag"></span><span class="mtext">Gerenciar Produtos</span>
							</a>
							<ul class="submenu">
                        ...
                        <li>
                            <a href="{{ route('seller.shop-settings') }}"
                                ...
                                <span class="mtext">Shop Settings
                                </span>
                            </a>
                        </li>
                    @endif
