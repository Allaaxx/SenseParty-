                ...
                <div class="right-sidebar-body-content">
                    ...
                    <div class="sidebar-radio-group pb-10 mb-10">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <label class="custom-control-label" for="sidebariconlist-2"><i class="fa fa-circle-o"></i></label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <ul id="accordion-menu">
                        ...
                        <li>
                            <a href="javascript:;" class="dropdown-toggle">
                                <span class="micon bi bi-textarea-resize"></span><span class="mtext">My Shop</span>
                            </a>
                            <ul class="submenu">
                                <li><a href="/admin/products">Products</a></li>
                                <li><a href="/admin/orders">Orders</a></li>
                                <li><a href="/admin/withdrawals">Withdrawals</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript:;" class="dropdown-toggle">
