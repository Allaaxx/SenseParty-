    ...
    <div class="container-auth">
        <div class="forms-container">
            <div class="signin-signup">
                <form action="{{ route('admin.login_handler') }}" method="POST" class="sign-in-form">
                    @csrf
                    <x-alert.form-alert />
                    ...
                    <div class="forgot-password text-center mt-3">
                        <a href="{{ route('admin.forgot-password')}}" style="color: #333; text-decoration: none;">Esqueceu a senha?</a>
                    </div>
                </form>
                ...
                <form action="#" method="POST" class="sign-up-form">
                    ...
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                        <input type="text" placeholder="Nome completo" name="name" value="{{ old('name') }} " disabled>
                    </div>
                    ...
                    <div class="input-field">
                        ...
                        <input type="email" placeholder="E-mail" name="email" value="{{ old('email') }}" disabled>
                    </div>
                    ...
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input type="password" placeholder="Senha" name="password" disabled>
                    </div>
                    ...
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input type="password" placeholder="Confirmar senha" name="confirm_password" disabled>
                    </div>
                    ...
                    <input  class="btn" value="Cadastrar" />
