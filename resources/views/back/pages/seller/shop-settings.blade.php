            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input id="shop_phone" class="form-control" type="text" name="shop_phone" placeholder="eg:+1 234 567 890"
                            value="{{ old('shop_phone', $shopInfo->shop_phone) }}">
                        @error('shop_phone')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="mb-2 mt-1" style="max-width:200px">
                            <a href="javascript:;" onclick="event.preventDefault(); document.getElementById('shop_logo').click();" class="edit-avatar"><i
                                class="fa fa-pencil"></i></a>
                            <img src="{{ $shopInfo->shop_logo ? '/images/shop/'. $shopInfo->shop_logo : '/images/shop/default_logo.svg' }}" alt="Shop Logo" class="img-thumbnail" id="shop_logo_preview">
