...
class AdminSettings extends Component
{
    ...
    public function updateGeneralSettings(){
        ...
        if($updated){
            $this->showToastr('success', 'Configurações gerais atualizadas com sucesso');
        }else{
            $this->showToastr('error', 'Erro ao atualizar as configurações gerais');
        }
    }
    ...
    public function updateSocialNetworks(){
        ...
        $updated = $social_network->save();

        if($updated){
            $this->showToastr('success', 'Redes sociais atualizadas com sucesso');
        }else{
            $this->showToastr('error', 'Erro ao atualizar as redes sociais');
        }
    }
